    ...
    <div className="p-4 min-h-screen">
      ...
      <div className="text-center mb-4">
        <button
          ...
          className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded w-40 transition"
        >
          Update Product
        </button>
        <button
          className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded w-40 ml-2 transition"
